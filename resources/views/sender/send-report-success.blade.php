...
@section('content')
    ...
    {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-lg-11">
                <h2 class="page-header" style="margin-left: 10px;">ทำรายการสั่งซื้อหมายเลข: {{ sprintf('%04d',$order->order_no) }} สำเร็จ</h2>
            </div>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <p><label>วันที่ทำรายการ:</label> {{ $order->created_at }}</p>
                                <p><label>จัดส่งแบบ:</label> ด่วน EMS</p>
                                <p><label>วันที่ตาดว่าจะได้รับสินค้า:</label> 18 เมษายน 2560 - 20 เมษายน 2560</p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"> 
